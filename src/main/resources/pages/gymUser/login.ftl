			...
			<div class="col-lg-6">
				<div class="panel panel-primary">
					<div class="panel-heading">
				    	<span class="glyphicon glyphicon-th-large">&nbsp;</span>工作室后台管理系统
				  	</div>
				  		...
				  		<form class="form-horizontal" role="form" id="dbform" action="#">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
								    ...
								    <img src="${gymUserPath}captcha-image" id="captchaImage" onclick="getCaptchaImg()"/>
								</div>
							</div>
							<div class="form-group">
...
function login(){
	...
	jQuery.post("${gymUserPath}loginValidate", $("#dbform").serializeArray(),function(result){
		if(result.success){
			document.location.href='${gymUserPath}admin/main';
		}else {
			alert(result.msg);
...
function getCaptchaImg(){
	$('#captchaImage').attr('src','${gymUserPath}captcha-image?r='+Math.random());
}
</script>
</html>